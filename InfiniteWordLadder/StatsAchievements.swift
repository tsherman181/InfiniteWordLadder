...
class SA: ObservableObject{
    ...
    let achievementDesc = ["Score 10 points in IWL game", "Score 50 points in IWL game", "Score 100 points in IWL game", "Guess 5 words in a row without giving up", "Guess 10 words in a row without giving up", "Guess 20 words in a row without giving up", "Guess the words \"Wine\" and \"Dine\" correctly", "Guess the words \"Life\" and \"Good\" correctly", "Guess the words \"Coin\" and \"Flip\" correctly", "Check the statistics page over 100 times", "Guess 10 words using the \"Picto\" font", "Guess 5 words in a row using the \"Picto\" font", "Guess a quarter of all the words in the game correctly", "Guess half of all the words in the game correctly", "Guess all of the words in the game correctly"]
    var highscore: Int
    var numInRow: Int
    var maxInRow: Int
